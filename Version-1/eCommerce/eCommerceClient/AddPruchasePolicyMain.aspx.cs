...
namespace Client
{
    public partial class AddPurchasePolicyMain : System.Web.UI.Page
    {
        ...
        {
            String str = new UserHandler().AddPurchasePolicyAndPolicy(Session["storeId"].ToString());
        ...
        {
            string str = new UserHandler().AddPurchasePolicyOrPolicy(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddPurchasePolicyConditionalPolicy(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        protected void ButtonMaxPro_Click(object sender, EventArgs e)
        {
            ...
            string str = new UserHandler().AddPurchasePolicyMaxProductPolicy(Session["storeId"].ToString(), ProductIdBox.Text, MaxBox.Text);
            if (str.Substring(1,6) != "Error:")
            {
                AndLabel.Visible = true;
                AndLabel.Text = "Policy Added";
        ...
        protected void ButtonMinPro_Click(object sender, EventArgs e)
        {
            ...
            string str = new UserHandler().AddPurchasePolicyMinProductPolicy(Session["storeId"].ToString(), ProductIdBoxMin.Text, MinBox.Text);
            if (str.Substring(1,6) != "Error:")
            {
                MinProductLabel.Visible = true;
        ...
        protected void ButtonMinAge_Click(object sender, EventArgs e)
        {
            ...
            string str = new UserHandler().AddPurchasePolicyMinAgePolicy(Session["storeId"].ToString(), AgeBox.Text);
            if (str.Substring(1,6) != "Error:")
            {
                MinAgeLabel.Visible = true;
        ...
        protected void ButtonRestrictedHours_Click(object sender, EventArgs e)
        {
            ...
            string str = new UserHandler().AddPurchasePolicyRestrictedHoursPolicy(Session["storeId"].ToString(), StartRestrictBox.Text, EndRestrictBox.Text, ProductIdBoxRes.Text);
            if (str.Substring(1,6) != "Error:")
            {
                RestrictedHoursLabel.Visible = true;
