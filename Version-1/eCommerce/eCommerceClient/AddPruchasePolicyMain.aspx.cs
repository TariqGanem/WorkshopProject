...
namespace Client
{
    public partial class AddPurchasePolicyMain : System.Web.UI.Page
    {
        ...
        {
            if(new UserHandler().AddPurchasePolicyAndPolicy(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddPurchasePolicyOrPolicy(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddPurchasePolicyConditionalPolicy(Session["storeId"].ToString()))
            {
        ...
        protected void ButtonMaxPro_Click(object sender, EventArgs e)
        {
            ...
            if (new UserHandler().AddPurchasePolicyMaxProductPolicy(Session["storeId"].ToString(), ProductIdBox.Text , MaxBox.Text ))
            {
                AndLabel.Visible = true;
                AndLabel.Text = "Policy Added";
                return;
        ...
        protected void ButtonMinPro_Click(object sender, EventArgs e)
        {
            ...
            if (new UserHandler().AddPurchasePolicyMinProductPolicy(Session["storeId"].ToString(), ProductIdBoxMin.Text, MinBox.Text))
            {
                MinProductLabel.Visible = true;
        ...
        protected void ButtonMinAge_Click(object sender, EventArgs e)
        {
            ...
            if (new UserHandler().AddPurchasePolicyMinAgePolicy(Session["storeId"].ToString(), AgeBox.Text))
            {
                MinAgeLabel.Visible = true;
        ...
        protected void ButtonRestrictedHours_Click(object sender, EventArgs e)
        {
            ...
            if (new UserHandler().AddPurchasePolicyRestrictedHoursPolicy(Session["storeId"].ToString(),StartRestrictBox.Text , EndRestrictBox.Text, ProductIdBoxRes.Text))
            {
                RestrictedHoursLabel.Visible = true;
