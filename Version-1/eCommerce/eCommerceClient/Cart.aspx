                                                ...
                                                <table align="center" style="width: 100%; border-bottom: 1px solid #CCC">
                                                    <tr>
                                                            ...
                                                            <table align="left" class="auto-style22">
                                                                ...
                                                                <tr>
                                                                    <td class="auto-style21">
                                                                        ...
                                                                        <asp:ImageButton ID="ImageButton1" ImageUrl="img/-.PNG" runat="server" CssClass="auto-style16" Height="30px" Width="30px" CommandArgument='<%#Eval("productName")+","+Eval("productId")+","+Eval("storeId")+","+Eval("Amount")%>' CommandName="down_command" />
                                                                            <asp:Label ID="Label1"  runat="server" CssClass="td" Height="30px" Text="" Width="54px"><%#Eval("Amount") %></asp:Label>
                                                                        <asp:ImageButton ID="ImageButton2" ImageUrl="img/plus.PNG" runat="server" CssClass="auto-style16" Height="30px" Width="30px"  CommandArgument='<%#Eval("productName")+","+Eval("productId")+","+Eval("storeId")+","+Eval("Amount")%>' CommandName="up_command" />
                                                        ...
                                                        <td style="text-align: right;">
                                                            <asp:Button ID="ButtonDelete" runat="server" Text="Delete" CommandArgument='<%#Eval("productName")+","+Eval("productId")+","+Eval("price")+","+Eval("storeId")+","+Eval("Amount")%>' CommandName="Delete_command" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
