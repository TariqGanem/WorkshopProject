...
namespace Client
{
    public partial class AddDiscountPolicyToMain : System.Web.UI.Page
    {
        ...
        {
            if(new UserHandler().AddDiscountPolicyConditionalDiscount(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountAnd(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountAddition(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountMax(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountMin(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountOr(Session["storeId"].ToString()))
            {
        ...
        {
            if (new UserHandler().AddDiscountPolicyDiscountXor(Session["storeId"].ToString()))
            {
        ...
        protected void ButtonDiscreet_Click(object sender, EventArgs e)
        {
            ...
            if (new UserHandler().AddDiscountPolicyDiscreetDiscount(Session["storeId"].ToString(), DisCodeBox.Text ))
            {
                DiscreetLabel.Visible = true;
        ...
        protected void ButtonVisibleDis_Click(object sender, EventArgs e)
        {
            ...
            if (type == "Shop")
            {
                if (new UserHandler().AddDiscountPolicyVisibleDiscount(Session["storeId"].ToString(), ExpirationDateBox.Text, PercentageBox.Text, type + "|"))
                {
                    VisibleLabel.Visible = true;
            ...
            {
                if (new UserHandler().AddDiscountPolicyVisibleDiscount(Session["storeId"].ToString(), ExpirationDateBox.Text, PercentageBox.Text, type + "|ProductIds"+TargetParamsBox.Text))
                {
                    VisibleLabel.Visible = true;
                    VisibleLabel.Text = "Discount Added";
                    return;
            ...
            {
                if (new UserHandler().AddDiscountPolicyVisibleDiscount(Session["storeId"].ToString(), ExpirationDateBox.Text, PercentageBox.Text, type + "|Categories" + TargetParamsBox.Text))
                {
                    VisibleLabel.Visible = true;
                    VisibleLabel.Text = "Discount Added";
                    return;
