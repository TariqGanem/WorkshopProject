...
namespace Client
{
    public partial class AddDiscountPolicyToMain : System.Web.UI.Page
    {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyConditionalDiscount(Session["storeId"].ToString());
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountAnd(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountAddition(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountMax(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountMin(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountOr(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        {
            string str = new UserHandler().AddDiscountPolicyDiscountXor(Session["storeId"].ToString());
            if (str.Substring(1,6) != "Error:")
            {
        ...
        protected void ButtonDiscreet_Click(object sender, EventArgs e)
        {
            ...
            string str = new UserHandler().AddDiscountPolicyDiscreetDiscount(Session["storeId"].ToString(), DisCodeBox.Text);
            if (str.Substring(1,6) != "Error:")
            {
                DiscreetLabel.Visible = true;
        ...
        protected void ButtonVisibleDis_Click(object sender, EventArgs e)
        {
            ...
            if (type == "Shop")
            {
                str = new UserHandler().AddDiscountPolicyVisibleDiscount(Session["storeId"].ToString(), ExpirationDateBox.Text, PercentageBox.Text, type + "|");
                if (str.Substring(1,6) != "Error:")
                {
                    VisibleLabel.Visible = true;
